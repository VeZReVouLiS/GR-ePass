...
1. Διαλέγετε **πάροχο** — Νέα Αττική Οδός ή Νέα Εγνατία Οδός.
2. Βάζετε **όνομα χρήστη / κωδικό** του portal **εκείνου** του παρόχου. Ο ίδιος
   χρήστης υπάρχει ανεξάρτητα σε κάθε πάροχο, οπότε τα στοιχεία της Αττικής
   Οδού δεν δουλεύουν στην Εγνατία και αντίστροφα.
3. Αν ο λογαριασμός σας έχει **πολλές συνδρομές**, επιλέγετε ποια θα προστεθεί
   (η διαδικασία επαναλαμβάνεται για τις υπόλοιπες).
4. Επιλέγετε **ποιους πομποδέκτες** θέλετε: «Όλοι» (και όσοι προστεθούν στο
...
Θέλετε και δεύτερο πάροχο, ή δεύτερη συνδρομή; Προσθέστε το integration ξανά —
...
Τα βήματα της προσθήκης είναι στο [Τι κάνει](#τι-κάνει).
